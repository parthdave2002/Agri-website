      ...
      <div className="max-w-1600 mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-5">
          ...
          <div className="w-full md:flex-1">
            <div className="relative bg-[#f9ebe7] rounded-lg overflow-hidden mb-3" style={{ backgroundImage: "url('/images/ad-image-3.png')", backgroundRepeat: 'no-repeat', backgroundPosition: 'right bottom' }} >
          ...
          {/* Right Banner */}
          <div className="w-full md:flex-1">
            <div className="relative bg-[#e6f3fa] rounded-lg overflow-hidden" style={{ backgroundImage: "url('/images/ad-image-4.png')", backgroundRepeat: 'no-repeat', backgroundPosition: 'right bottom'}}>
              <div className="p-[4rem]">
