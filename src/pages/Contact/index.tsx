...
const ContactusSection = () => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      phone_number: Yup.number().required("Please enter phone number").min(10, "Phone number must be minimum 10 digits") .max(10, "Phone number must be maximum 10 digits"),
    }),
      ...
      <div className="min-h-screen md:flex ">
        ...
        <div className="w-full md:w-1/2 bg-white p-10">
          ...
          {/* <form className="space-y-8">
            ...
            <button type="submit" className=" text-sm font-medium text-black  border border-green-500 px-8 py-2 flex justify-center hover:bg-green-600 hover:text-white inline-flex items-center"> Submit <span className="ml-2">→</span>   </button>
          </form> */}
