  ...
  return (
    <div className='p-6'>
      <div className="max-w-1600 mx-auto px-4">
        ...
        <p className=' text-[1rem]'>b. Informational Purpose  </p>
        <p className='mb-6 text-[1rem]'>Content is for general agricultural reference and product guidance. While we strive for accuracy, we do not warrant that product information, pricing, or descriptions are error-free, complete, or current. </p>

        <p className='mb-2  font-heading  text-[1.2rem]'>2. Products and Services </p>
        <p className='text-[1rem]'>a. Product Availability </p>
        ...
        <p className='text-[1rem]'>b. Pricing  </p>
        ...
        <p className='text-[1rem]'>c. Orders  </p>
        <p className='mb-6 text-[1rem]'>Once an order is placed, you will receive an email or SMS confirmation. This confirmation does not signify our acceptance; we reserve the right to cancel any order due to stock issues, payment failures, or policy violations.</p>

        <p className='mb-2  font-heading  text-[1.2rem]'>3. Delivery & Shipping </p>
        <p className='mb-2 text-[1rem]'>a. Delivery Areas </p>
        ...
        <p className='mb-2 text-[1rem]'>b. Delivery Timelines </p>
        ...
        <p className='mb-2 text-[1rem]'>c. Delays  </p>
        <p className='mb-6 text-[1rem]'>We are not liable for delivery delays caused by events outside our control (e.g., natural disasters, strikes, transport issues). </p>

        <p className='mb-2 text-[1rem]'>4. Returns, Refunds, and Cancellations</p>
        <p className='mb-2 text-[1rem]'>a. Return Policy </p>
        ...
        <p className='mb-2 text-[1rem]'>b. Refunds</p>
        ...
        <p className='mb-2 text-[1rem]'>c. Order Cancellations </p>
        <p className='mb-6 text-[1rem]'>You can cancel an order before it is shipped. After dispatch, cancellations are not allowed, but you may request a return (if applicable). </p>


        <p className='mb-2 text-[1rem]'>5. Payments</p>
        <p className='mb-2 text-[1rem]'>a. Accepted Methods </p>
        ...
        <p className='mb-2 text-[1rem]'>b. Payment Security</p>
        <p className='mb-6 text-[1rem]'>All online payments are processed securely through encrypted gateways. We do not store your payment details. </p>


        <p className='mb-4 text-[1rem]'> 6. User Responsibilities</p>
          ...
          <p className='mb-6 text-[1rem]'>• 	You are responsible for maintaining the confidentiality of your login credentials.</p>


        <p className='mb-4 text-[1rem]'>7. Intellectual Property </p>
        <p className='mb-6 text-[1rem]'>All website content – including images, text, logos, product catalogs, videos, and software – is the property of AgriBharat or its licensors. Reproduction or reuse without written consent is strictly prohibited. </p>

        <p className='mb-4 text-[1rem]'>8. Third-Party Links </p>
        <p className='mb-6 text-[1rem]'>Our website may contain links to third-party websites for additional information. We do not endorse or guarantee the content or practices of these sites and shall not be held responsible for any interaction with them.</p>

        <p className='mb-4 text-[1rem]'>9. Account Termination</p>
        <p className='mb-6 text-[1rem]'>We reserve the right to terminate or suspend any user account found to be in violation of these Terms or engaging in fraud, harassment, or harmful activity.</p>

        <p className='mb-4 text-[1rem]'>10. Limitation of Liability</p>
        ...
        <p className='mb-4 text-[1rem]'>11. Governing Law & Jurisdiction</p>
        <p className='mb-6 text-[1rem]'>These Terms are governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of the courts in Ahmedabad, Gujarat. </p>

        <p className='mb-4 text-[1rem]'>12. Modifications to Terms</p>
        <p className='mb-6 text-[1rem]'>We may revise these Terms at any time without prior notice. Continued use of the website implies your acceptance of the latest version. </p>

        <p className='mb-4 text-[1rem]'>13. Contact Information</p>
        ...
        <p className='mb-6 text-[1rem]'>Phone: +91 9100029429/9100029329 </p>


        <h2 className="text-[1.5rem] md:text-[2rem] font-heading font-semibold my-5"> Privacy Policy  </h2>
        <p className=' text-[1rem]'> Effective Date: 01/01/2025</p>
        <div className='mb-6 text-[1rem]'>AgriBharat (“we”, “our”, “us”) is committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your personal information when you visit or make a purchase from [www.agribharat.com] (the “Website”). By using our website, you agree to the terms of this policy.</div>

        <p className='mb-2 text-[1rem]'>1. Information We Collect </p>
        ...
        <p className='mb-4 text-[1rem]'>We collect this information when you:</p>
          ...
          <p className='mb-6 text-[1rem]'>• Subscribe to offers or updates</p>

        <p className='mb-2 text-[1rem]'>2. How We Use Your Information </p>
        ...
        <p className='mb-6 text-[1rem]'>We will never sell, lease, or share your information with third parties for marketing purposes without your explicit consent. </p>


        <p className='mb-2 text-[1rem]'>3. Data Protection & Security</p>
        ...
        <p className='mb-6 text-[1rem]'>However, while we strive to protect your data, no method of transmission over the internet is 100% secure. Use the website at your own discretion.</p>

        <p className='mb-2 text-[1rem]'>4. Sharing with Third Parties</p>
        ...
        <p className='mb-6 text-[1rem]'>These service providers are required to maintain the confidentiality and integrity of your information.</p>

        <p className='mb-2 text-[1rem]'>5. User Rights</p>
        ...
        <p className='mb-6 text-[1rem]'>To make a request, contact us at: agribharat.info@gmail.com</p>

        <p className='mb-4 text-[1rem]'>6. Policy Updates</p>
        <p className='mb-6 text-[1rem]'>We may update this Privacy Policy occasionally to reflect changes in legal, regulatory, or operational requirements. Updates will be posted on this page, and we encourage you to review this policy periodically. </p>

        <p className='mb-4 text-[1rem]'>7. Children’s Privacy</p>
        <p className='mb-6 text-[1rem]'>Our services are not intended for individuals under the age of 18 without parental guidance. We do not knowingly collect data from children. </p>
        ...
        <p className='mb-6 text-[1rem]'>Email: agribharat.info@gmail.com </p>
        ...
        <p className='mb-4 text-[1rem]'>1. Order Cancellation</p>
          ...
          <p className='mb-6 text-[1rem]'>• Once the order has been dispatched, cancellation is not possible but can be returned.</p>

        <p className='mb-2 text-[1rem]'>2. Refund Policy (For Online Payments)</p>
        ...
        <p className='mb-4 text-[1rem]'>b. If the Order is Cancelled After Shipping:</p>
          ...
          <p className='mb-6 text-[1rem]'>• Refunds are credited to the AgriBharat Wallet only, not to the original payment method.</p>


        <p className='mb-2 text-[1rem]'>3. Replacement Policy (For Damaged or Defective Products)</p>
        ...
        <p className='mb-4 text-[1rem]'>To request a replacement, please: </p>
          ...
          <p className='mb-4 text-[1rem]'>• Contact our support team within 7 days of receiving the product</p>


        <p className='mb-2 text-[1rem]'>4. Customer Change of Mind (No Longer Wants the Product)</p>
        <p className='mb-4 text-[1rem]'>If the farmer decides not to keep the product after delivery: </p>
          ...
          <p className='mb-6 text-[1rem]'>• The balance can be used as a discount on any future purchases.</p>

        <p className='mb-4 text-[1rem]'>5. How to Contact Us</p>
