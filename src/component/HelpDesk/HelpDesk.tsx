  ...
  return (
    <>
      <div className="fixed bottom-28 right-6 z-[9998] flex flex-col items-end space-y-2">
        ...
        <button className="fixed bottom-6 right-6 rounded-full bg-green-600 hover:bg-green-700 p-0.5 shadow-lg text-white transition animate-bounce" onClick={() => setIsOpen(!isOpen)} >    {isOpen ? <IoCloseSharp className='text-[2.5rem]' /> : <img src='/public/images/support-icon-2.webp' className='rounded-full'  height={50} width={50} />}   </button>
