        ...
        <div className="grid grid-cols-1 justify-items-center md:grid-cols-3 gap-8">
            ...
            <div className="col-span-1">
              ...
              <div className='text-md md:text-[1rem] font-heading font-semibold mb-4'> {t("Email")} : agribharat.info@gmail.com</div>
                <div className="flex space-x-3 ">
                  <a  target="_blank" rel='noopener noreferre'  href="https://chat.whatsapp.com/EpxTJUNTU8Q1NKUAS3RjBM"  className="w-10 h-10 flex items-center justify-center transition cursor-pointer">  <LazyLoadImage effect="blur" src="/public/images/whatsapp.png" />   </a>
                  <a  target="_blank" rel='noopener noreferre'  href="https://www.instagram.com/agribharat.in?igsh=MXQwbnlwMmI5c3RvMw=="  className="w-10 h-10 flex items-center justify-center transition cursor-pointer">  <LazyLoadImage effect="blur"  src="/public/images/instagram.png" />   </a>
                  <a  target="_blank" rel='noopener noreferre'  href="https://youtube.com/@agribharat2023?si=ip4lwikEkp4SCBgy"  className="w-10 h-10 flex items-center justify-center transition cursor-pointer">  <LazyLoadImage effect="blur"  src="/public/images/youtube.png" />   </a>
                  <a  target="_blank" rel='noopener noreferre'  href="https://www.facebook.com/agribharat.in/"  className="w-10 h-10 flex items-center justify-center transition cursor-pointer"> <LazyLoadImage effect="blur"  src="/public/images/facebook.png" />   </a>
                </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-center">
              ...
              <li><div onClick={() => RedictCall("/terms")} className="cursor-pointer hover:underline">{t("legal policies")}</div></li>
            </ul>
          </div>
